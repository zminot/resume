...
\begin{paracol}{2}
    ...
    \compact[May 2021 - Aug. 2021]{Amazon, Inc}{Incoming Software Development Engineer Intern}{
        ...
        {Identified unsupported packages and defective unit tests within the existent project, and brought the
        information to light with to team along with plans to fix}
    }
    \compact[Jan. 2021 - May 2021]{Rockefeller Capital Management -- Merlin Wealth Management}{Software Development Intern}{
        {Part-time development work of internal application to aid in management of company data with \textbf{React} and \textbf{Flask}}}
    ...
    \compact{Misc}{}{Music, Frisbee, NBA, Formula 1, Rock Climbing}
